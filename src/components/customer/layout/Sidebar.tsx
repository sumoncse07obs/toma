...
const navItems = [
  ...
  { to: "/customer/youtube", label: "YouTube Automation", icon: "▶️" },
  { to: "/customer/topic", label: "Topic Automation", icon: "📚" },
  { to: "/customer/launch", label: "Launch Automation", icon: "🚀" },
    ...
    <>
      ...
      >
        ...
        <div className="h-16 flex items-center px-4 border-b justify-between">
          <NavLink
            to="/customer"   // or "/" if that's your home
