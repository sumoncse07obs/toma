// src/components/LaunchPromptSettings.tsx
...
const PROMPT_FOR: PromptFor = "launch"; // 👈 hard-locked per your ask
...
export default function LaunchPromptSettings() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      if (currentId) {
        // PUT by id (customer_id immutable; prompt_for remains "launch")
        const { id: _i, customer_id: _c, created_at: _ca, updated_at: _ua, ...rest } =
          form as any;
