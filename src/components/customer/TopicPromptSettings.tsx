// src/components/TopicPromptSettings.tsx
...
const PROMPT_FOR: PromptFor = "topic"; // 👈 hard-locked per your ask
...
export default function TopicPromptSettings() {
  ...
  // load setting for {customer_id, prompt_for: Topic}
  React.useEffect(() => {
  ...
  async function handleSave() {
    ...
    try {
      ...
      if (currentId) {
        // PUT by id (customer_id immutable; prompt_for remains "topic")
        const { id: _i, customer_id: _c, created_at: _ca, updated_at: _ua, ...rest } =
          form as any;
