// src/components/customer/youtube_page/ViewYoutubeContents.tsx
...
export default function ViewYoutubeContents() {
  ...
  if (error && !content) {
    return (
      <div className="p-4 md:p-6">
        <div className="mb-4">
          <Link to="/customer/youtube/list" className="text-blue-600 hover:text-blue-700 text-sm">
      ...
      <div className="mb-6">
        <div className="flex items-center justify-between mb-4">
          ...
          <div className="flex items-center gap-2">
            ...
            {content.video_url ? (
              <Link
                to={`/customer/youtube/post/${content.id}`}
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-lg border p-4">
          ...
          <div className="mt-2 text-xs text-gray-600">
            ...
            <Link to={`/customer/youtube/posttoblotato/${content.id}`} className="text-blue-600 hover:text-blue-700 underline">
              Click here...
            </Link>
          </div>
        </div>
