// src/components/customer/topic_pages/ListTopicContents.tsx
...
export default function ListTopicContents({ customerId, perPage = 10 }: Props) {
  ...
  // resolve customer id with retries
  React.useEffect(() => {
    if (!isAuthed()) {
  ...
  // load once user known (or no auth)
  React.useEffect(() => {
