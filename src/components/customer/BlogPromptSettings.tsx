...
const PROMPT_FOR: PromptFor = "blog"; // 👈 hard-locked per your ask
...
export default function BlogPromptSettings() {
  ...
  async function handleSave() {
    ...
    try {
      ...
      if (currentId) {
        // PUT by id (customer_id immutable; prompt_for remains "blog")
        const { id: _i, customer_id: _c, created_at: _ca, updated_at: _ua, ...rest } =
          form as any;
  ...
  // ❌ Removed handleClearAll() per your request
